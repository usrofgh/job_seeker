...
from vacancies.models import WorkUa, FirstVacancySession, Dou


class DouSpider(SpiderBlueprint):
    SPIDER_NAME = "dou"
    BASE_URL = "https://jobs.dou.ua/vacancies/?category=Python&search=python"
    DATE_FORMAT = "%d %B %Y"
